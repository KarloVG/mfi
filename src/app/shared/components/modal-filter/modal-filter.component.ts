  ...
  ngOnInit(): void {
    ...
    if(filterValues) {
      this.filterFormGroup.patchValue({
        ...
        Banka: filterValues.Banka ? filterValues.Banka : '',
        BankaB: filterValues.BankaB ? filterValues.BankaB : '',
        Drzava: filterValues.Drzava ? filterValues.Drzava : '',
        DrzavaB: filterValues.DrzavaB ? filterValues.DrzavaB : '',
        DatumTrasakcijeOd: filterValues.DatumTrasakcijeOd ? filterValues.DatumTrasakcijeOd : '',
        DatumTrasakcijeDo: filterValues.DatumTrasakcijeDo ? filterValues.DatumTrasakcijeDo : '',
